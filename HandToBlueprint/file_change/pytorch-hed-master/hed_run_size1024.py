...
def estimate(tenInput):
    ...
    assert(intHeight == 1024) # remember that there is no guarantee for correctness, comment this line out if you acknowledge this and want to continue
...
if __name__ == '__main__':
    ...
    path_dir = './no_ocr_binary2_jpg/'
 
    file_list = os.listdir(path_dir)

    for name in file_list:
        arguments_strModel = 'bsds500' # only 'bsds500' for now
        arguments_strIn =  './no_ocr_binary2_jpg/' + name
        arguments_strOut = './no_ocr_binary3_jpg/' + name
